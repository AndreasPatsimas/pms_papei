...
class TestWB(object):
    ...
    def test_wdi_download(self):
        ...
        # ...but NOT a crash inducing country code (World Bank strips panda
    ...
    def test_wdi_download_w_retired_indicator(self):
        ...
        # panda module.  GDPPCKD used to be a common symbol.
        #
        # This test is written to ensure that error messages to panda users
