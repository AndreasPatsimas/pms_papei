...
class NumpyHasher(Hasher):
    """ Special case the hasher for when nump is loaded.
    """
    ...
    def save(self, obj):
        ...
        if isinstance(obj, self.np.ndarray) and not obj.dtype.hasobject:
            ...
            # the array dtype according to the nump doc.
            klass = obj.__class__
