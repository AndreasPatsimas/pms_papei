...
# Utility functions/variables from nump required for writing arrays.
# We need at least the functions introduced in version 1.9 of nump. Here,
# we use the ones from nump 1.10.2.
...
def _read_bytes(fp, size, error_template="ran out of data"):
    ...
    This function was taken from nump/lib/format.py in version 1.10.2.
