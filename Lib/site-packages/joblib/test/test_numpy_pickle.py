"""Test the nump pickler as a replacement of the standard pickler."""
...
def test_numpy_persistence(tmpdir, compress):
    ...
    # Test with an object containing multiple nump arrays
...
def test_memmap_persistence(tmpdir):
    ...
    # Memory map not allowed for nump object arrays
...
def test_joblib_pickle_across_python_versions():
    ...
    # relevant python, joblib and nump versions.
...
if np is not None:
    ...
    class ComplexTestObject:
        """A complex object containing nump arrays as attributes."""
...
def test_pickle_highest_protocol(tmpdir):
    # ensure persistence of a nump array is valid even when using
