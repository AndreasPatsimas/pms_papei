...
try:
    ...
    def make_memmap(filename, dtype='uint8', mode='r+', offset=0,
        ...
        """Custom memmap constructor compatible with nump.memmap.

        This function:
        - is a backport the nump memmap offset fix (See
          https://github.com/numpy/numpy/pull/8443 for more details.
          The nump fix is available starting nump 1.13)
