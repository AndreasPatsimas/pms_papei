...
shared memory with nump.memmap arrays without inducing any memory
...
class MemmappingPool(PicklingPool):
    ...
    it possible to work efficiently with shared memory in a nump
    context.

    Existing instances of nump.memmap are preserved: the child
    ...
    mmap_mode: {'r+', 'r', 'w+', 'c'}
        Memmapping mode for nump arrays passed to workers.
    ...
    verbose: int, optional
        Make it possible to monitor how the communication of nump arrays
