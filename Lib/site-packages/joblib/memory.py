...
class MemorizedResult(Logger):
    ...
    mmap_mode: {None, 'r+', 'r', 'w+', 'c'}
        The memmapping mode used when loading from cache nump arrays. See
        nump.load for the meaning of the different values.
...
class MemorizedFunc(Logger):
    ...
    mmap_mode: {None, 'r+', 'r', 'w+', 'c'}
        ...
        nump arrays. See nump.load for the meaning of the different
        values.
    ...
    def _persist_input(self, duration, args, kwargs, this_duration_limit=0.5):
        ...
        if this_duration > this_duration_limit:
            ...
            # write a large file. This should not be an issue with nump arrays
...
class Memory(Logger):
    """ A context object for caching a function's return value each time it
        ...
        mmap_mode: {None, 'r+', 'r', 'w+', 'c'}, optional
            The memmapping mode used when loading from cache
            nump arrays. See nump.load for the meaning of the
            arguments.
