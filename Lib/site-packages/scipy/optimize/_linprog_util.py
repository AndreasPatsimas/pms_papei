...
_LPProblem.__doc__ = \
    ...
    bounds : various valid formats, optional
        ...
        * a sequence of N sequences, each with 2 values.
        ...
        Absent lower and/or upper bounds can be specified as -nump.inf (no
        lower bound), nump.inf (no upper bound) or None (both).
...
def _format_A_constraints(A, n_x, sparse_lhs=False):
    ...
    sparse_lhs : bool
        ...
        coo_matrix instead of a nump array.
...
def _parse_linprog(lp, options):
    ...
    # Convert lists to nump arrays, etc...
