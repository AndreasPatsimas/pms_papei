...
class VisitingDistribution(object):
    ...
    visiting_param : float
        ...
        object.
    rand_gen : {`~nump.random.RandomState`, `~nump.random.Generator`}
        A `~nump.random.RandomState`, `~nump.random.Generator` object
...
class StrategyChain(object):
    ...
    rand_gen : {`~nump.random.RandomState`, `~nump.random.Generator`}
        A `~nump.random.RandomState` or `~nump.random.Generator`
...
def dual_annealing(func, bounds, args=(), maxiter=1000,
    ...
    seed : {int, `~nump.random.RandomState`, `~nump.random.Generator`}, optional
        If `seed` is not specified the `~nump.random.RandomState` singleton is
        used.
