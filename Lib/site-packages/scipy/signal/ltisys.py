    ...
    *system: arguments
    ...
    def __truediv__(self, other):
        ...
        if isinstance(other, np.ndarray) and other.ndim > 0:
            ...
            raise ValueError("Cannot divide StateSpace by non-scalar nump arrays")
...
def _KNV0(B, ker_pole, transfer_matrix, j, poles):
    ...
    # To debug with nump qr uncomment the line below
...
def _YT_real(ker_pole, Q, transfer_matrix, i, j):
    ...
    # VM is V.T with nump we want the first two lines of V.T
...
def _YT_loop(ker_pole, transfer_matrix, poles, B, maxiter, rtol):
    ...
    # Stick to the indices in the paper and then remove one to get nump array
