...
def correlate(in1, in2, mode='full', method='auto'):
    ...
    if method in ('fft', 'auto'):
        ...
        # fastpath to faster nump.correlate for 1d inputs when possible
...
def _np_conv_ok(volume, kernel, mode):
    """
    See if nump supports convolution of `volume` and `kernel` (i.e. both are
...
def convolve(in1, in2, mode='full', method='auto'):
    ...
    See Also
    --------
    nump.polymul : performs polynomial multiplication (same operation, but
    ...
    if method == 'fft':
        ...
        # fastpath to faster nump.convolve for 1d inputs when possible
...
def deconvolve(signal, divisor):
    ...
    See Also
    --------
    nump.polydiv : performs polynomial division (same operation, but
                    also accepts poly1d objects)
...
def unique_roots(p, tol=1e-3, rtype='min'):
    ...
    determined. For a more general routine, see `nump.unique`.
...
def residue(b, a, tol=1e-3, rtype='avg'):
    ...
    See Also
    --------
    invres, residuez, nump.poly, unique_roots
...
def lfilter_zi(b, a):
    ...
    #    lfiltic(b, a, y=nump.ones_like(a), x=nump.ones_like(b)).
    #
