...
# In nump 1.12 and above, np.power refuses to raise integers to negative
...
class exponweib_gen(rv_continuous):
    ...
    See Also
    --------
    weibull_min, nump.random.RandomState.weibull
...
class weibull_min_gen(rv_continuous):
    ...
    See Also
    --------
    weibull_max, nump.random.RandomState.weibull, exponweib
    ...
    ``nump.random.weibull``).  Special shape values are :math:`c=1` and
...
class rv_histogram(rv_continuous):
    ...
    Create a scipy.stats distribution from a nump histogram
