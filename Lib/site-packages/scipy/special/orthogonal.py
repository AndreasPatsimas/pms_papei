...
def roots_laguerre(n, mu=False):
    ...
    scipy.integrate.quadrature
    scipy.integrate.fixed_quad
    nump.polynomial.laguerre.laggauss
...
def roots_hermite(n, mu=False):
    ...
    scipy.integrate.quadrature
    scipy.integrate.fixed_quad
    nump.polynomial.hermite.hermgauss
    roots_hermitenorm
...
def roots_hermitenorm(n, mu=False):
    ...
    scipy.integrate.quadrature
    scipy.integrate.fixed_quad
    nump.polynomial.hermite_e.hermegauss
...
def roots_chebyt(n, mu=False):
    ...
    scipy.integrate.quadrature
    scipy.integrate.fixed_quad
    nump.polynomial.chebyshev.chebgauss
...
def roots_legendre(n, mu=False):
    ...
    scipy.integrate.quadrature
    scipy.integrate.fixed_quad
    nump.polynomial.legendre.leggauss
