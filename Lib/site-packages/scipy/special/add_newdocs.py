...
# called from nump.lib, but in this file add_newdoc puts the
...
add_newdoc("eval_chebyt",
    ...
    hyp2f1 : Gauss hypergeometric function
    nump.polynomial.chebyshev.Chebyshev : Chebyshev series
...
add_newdoc("eval_legendre",
    ...
    hyp2f1 : Gauss hypergeometric function
    nump.polynomial.legendre.Legendre : Legendre series
...
add_newdoc("eval_laguerre",
    ...
    nump.polynomial.laguerre.Laguerre : Laguerre series
...
add_newdoc("eval_hermite",
    ...
    nump.polynomial.hermite.Hermite : Physicist's Hermite series
...
add_newdoc("eval_hermitenorm",
    ...
    nump.polynomial.hermite_e.HermiteE : Probabilist's Hermite series
...
add_newdoc("gdtria",
    ...
    out : ndarray, optional
        If a fourth argument is given, it must be a nump.ndarray whose size
