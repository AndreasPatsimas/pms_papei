...
def save_npz(file, matrix, compressed=True):
    ...
    nump.savez: Save several arrays into a ``.npz`` archive.
    nump.savez_compressed : Save several arrays into a compressed ``.npz`` archive.
    ...
    >>> sparse_matrix
    <2x3 sparse matrix of type '<class 'nump.int64'>'
...
def load_npz(file):
    ...
    nump.load: Load several arrays from a ``.npz`` archive.
