...
class spmatrix(object):
    ...
    def reshape(self, *args, **kwargs):
        ...
        See Also
        --------
        nump.matrix.reshape : NumPy's implementation of 'reshape' for
                               matrices
        """
    ...
    def resize(self, shape):
        ...
        Notes
        -----
        The semantics are not identical to `nump.ndarray.resize` or
        `nump.resize`. Here, the same data will be maintained at each index
        before and after reshape, if that index is within the new bounds. In
        nump, resizing maintains contiguity of the array, moving elements
    ...
    def transpose(self, axes=None, copy=False):
        ...
        See Also
        --------
        nump.matrix.transpose : NumPy's implementation of 'transpose'
                                 for matrices
        """
    ...
    def getH(self):
        ...
        See Also
        --------
        nump.matrix.getH : NumPy's implementation of `getH` for matrices
        """
    ...
    def todense(self, order=None, out=None):
        ...
        out : ndarray, 2-D, optional
            If specified, uses this array (or `nump.matrix`) as the
        ...
        arr : nump.matrix, 2-D
            ...
            array (rather than a `nump.matrix`), it will be filled
            with the appropriate values and returned wrapped in a
            `nump.matrix` object that shares the same memory.
        """
    ...
    def sum(self, axis=None, dtype=None, out=None):
        ...
        See Also
        --------
        nump.matrix.sum : NumPy's implementation of 'sum' for matrices
    ...
    def mean(self, axis=None, dtype=None, out=None):
        ...
        See Also
        --------
        nump.matrix.mean : NumPy's implementation of 'mean' for matrices
    ...
    def diagonal(self, k=0):
        ...
        See also
        --------
        nump.diagonal : Equivalent nump function.
