...
# Add the nump unary ufuncs for which func(0) = 0 to _data_matrix.
for npfunc in _ufuncs_with_fixed_point_at_zero:
    ...
    def _create_method(op):
        ...
        method.__doc__ = ("Element-wise %s.\n\n"
                          "See `nump.%s` for more information." % (name, name))
...
class _minmax_mixin(object):
    ...
    def max(self, axis=None, out=None):
        ...
        nump.matrix.max : NumPy's implementation of 'max' for matrices
    ...
    def min(self, axis=None, out=None):
        ...
        nump.matrix.min : NumPy's implementation of 'min' for matrices
