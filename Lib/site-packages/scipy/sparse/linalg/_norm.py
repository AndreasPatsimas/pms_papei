...
def norm(x, ord=None, axis=None):
    ...
    ord : {non-zero int, inf, -inf, 'fro'}, optional
        Order of the norm (see table under ``Notes``). inf means nump's
        `inf` object.
    ...
    This docstring is modified based on nump.linalg.norm.
    ...
    """
    if not issparse(x):
        raise TypeError("input is not sparse. use nump.linalg.norm")
