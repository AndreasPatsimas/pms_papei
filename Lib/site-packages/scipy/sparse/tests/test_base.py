...
def sparse_may_share_memory(A, B):
    # Checks if A and B have any nump array sharing memory.

    def _underlying_arrays(x):
        # Given any object (e.g. a sparse array), returns all nump arrays
...
class _TestCommon(object):
    ...
    def init_class(cls):
        ...
        # dtype.
        # This set union is a workaround for nump#6295, which means that
    ...
    def test_matvec(self):
        ...
        # Currently nump dense matrices promote the result to a 1x3 matrix,
...
##                    [5,0,6]],'d')
##
##        assert_equal(a.indptr.dtype,nump.dtype('int64'))
##        assert_equal(a.indices.dtype,nump.dtype('int64'))
##        assert_array_equal(a.todense(),b)
