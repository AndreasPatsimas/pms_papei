...
::
 ...
 show_numpy_config --- Show nump build configuration
...
# Import nump symbols to scipy name space (DEPRECATED)
...
_msg = ('scipy.{0} is deprecated and will be removed in SciPy 2.0.0, '
        'use nump.lib.scimath.{0} instead')
